...
class Item extends CI_Model{
    ...
    */
     ...
     * @return boolean
     */
    public function add($itemName, $itemQuantity, $itemPrice, $itemDescription, $itemCategory){
        $data = ['name'=>$itemName, 'quantity'=>$itemQuantity, 'unitPrice'=>$itemPrice, 'description'=>$itemDescription, 'category'=>$itemCategory];
    ...
    * @param type $itemQty
    */
   public function edit($itemId, $itemName, $itemDesc, $itemPrice, $itemQty, $itemCategory){
       $data = ['name'=>$itemName, 'unitPrice'=>$itemPrice, 'description'=>$itemDesc, 'quantity'=>$itemQty, 'category'=>$itemCategory];
